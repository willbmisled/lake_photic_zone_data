...
#' NOTE: this is a modified version of the function from the goatscape package
#'
...
nlcd <- tryCatch(FedData::get_nlcd(template = landscape_alb,
                          ...
                          force.redo = force.redo), 
                            error = function(e) stop("No data returned by NLCD; Check that input landscape is correctly projected and intersects the conerminous United States; try again using a new, unique label."))
